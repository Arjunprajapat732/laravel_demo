          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form action="{{ url('signup_user') }}" method="post" class="mx-1 mx-md-4">
                  @csrf
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="password" name="user_pass_repeat" id="form3Example4cd" class="form-control" />
                  ...
                  <div class="d-flex justify-content-between mx-4 mb-3 mb-lg-4">
                    ...
                    <button onclick="window.location.href='{{ url('login') }}'" type="button" class="btn btn-primary btn-lg">Login</button>
                  </div>
